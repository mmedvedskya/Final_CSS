async function getResponce() {
   let responce = await fetch("pick_me.json")
    ...
    for (key in content) {
        ...
        <h5 class="card-title" style="text-align: center; margin: 1em;">${content[key].title}</h5>
        <p class="card-text">${content[key].description}.<br> <b>Цена ${content[key].price} руб.</b></p>
